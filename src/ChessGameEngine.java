...
public class ChessGameEngine {
    ...
    public void determineActionFromSquareClick(MouseEvent e) {
        ...
        if (firstClick) {
            ...
            handleSubsequentClicks(squareClicked);
        }
    }
    ...
    private void handleFirstClick(BoardSquare squareClicked) {
        ...
        if (selectedPieceIsValid()) {
            ...
            handleInvalidSelectionError(squareClicked);
        }
    }

    private void handleSubsequentClicks(BoardSquare squareClicked) {
    ...
    private void handleInvalidSelectionError(BoardSquare squareClicked) {
    ...
    private void handleMove(BoardSquare squareClicked) {
        ...
        if (moveSuccessful) {
            ...
            handleInvalidMoveError(squareClicked);
        }

        firstClick = true;
    }

    private void handleInvalidMoveError(BoardSquare squareClicked) {
